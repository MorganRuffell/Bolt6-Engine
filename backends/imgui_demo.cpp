...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            ImVec2 size = ImVec2(32.0f, 32.0f);                     // BufferSize of the image we want to make visible
...
struct ExampleAppConsole
{
    ...
    int                   HistoryPos;    // -1: new line, 0..History.BufferSize-1 browsing history.
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        //      for (int i = 0; i < Items.BufferSize; i++)
        //   With:
        //      ImGuiListClipper clipper;
        //      clipper.Begin(Items.BufferSize);
        //      while (clipper.Step())
        //         for (int i = clipper.DisplayStart; i < clipper.DisplayEnd; i++)
